...
async function main() {
  ...
  // Output follows project/task convention.
  ...
  const baseOutputDir = args.output || path.resolve(__dirname, '..', '..', '..', taskOutputDir, 'requirements', 'jira');
...
Ví dụ:
  ...
  node jira_fetcher.js --issue PROJ-123 --format md --output ./<PROJECT_OUTPUT_DIR>/tasks/PROJ-123/requirements/jira
  `);
}
