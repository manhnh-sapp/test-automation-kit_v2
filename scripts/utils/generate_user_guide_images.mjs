...
const boards = [
  ...
  },
  {
    ...
    inputs: ['knowledge/ (bug + historical)', 'risk_model.json (Impact/depthPolicy)', 'NFR/SLA ngưỡng', 'ui_catalog.json', 'Test account low/high', 'Docker/k6 (load)'],
    steps: [
      ...
      { icon: 'LOAD', c: C.danger, title: 'Load Loại B', body: 'npm run load — k6/Docker, non-prod, cap' },
      { icon: 'MOB', c: C.info, title: 'Mobile-web', body: 'test:mobile-web — device emulation thật' },
